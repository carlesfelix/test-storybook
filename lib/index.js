...
function RadioButton(props) {
    ...
    return (jsxRuntime.exports.jsxs("label", __assign({ className: radioButtonClassName, onBlur: blurHandler }, { children: [!!label && (jsxRuntime.exports.jsx("span", __assign({ className: "radio-button-label radio-button-element" }, { children: label }), void 0)), jsxRuntime.exports.jsx("input", { type: "radio", className: "radio-button-input-native radio-button-element", name: name, checked: value, onChange: changeHandler }, void 0), jsxRuntime.exports.jsx("span", __assign({ className: "radio-button-input radio-button-element" }, { children: jsxRuntime.exports.jsx("span", { className: "radio-button-input__checked" }, void 0) }), void 0)] }), void 0));
}
